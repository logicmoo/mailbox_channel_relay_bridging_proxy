...
from mailbox_channel_relay_bridging_proxy.whatsapp_personal_adapter import WhatsAppPersonalAdapter
...
def test_personal_whatsapp_signed_group_and_send(monkeypatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr("mailbox_channel_relay_bridging_proxy.whatsapp_personal_adapter.listeners_for",
