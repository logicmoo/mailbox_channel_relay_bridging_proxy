...
from mailbox_channel_relay_bridging_proxy.telegram_adapter import TelegramAdapter
...
def test_telegram_inbound_outbound_threads_and_attachments(monkeypatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr("mailbox_channel_relay_bridging_proxy.telegram_adapter.listeners_for", lambda adapter: [listener])
    session = Session()
