...
from mailbox_channel_relay_bridging_proxy.viber_adapter import ViberAdapter
...
def test_viber_signed_webhook_inbound_and_outbound(monkeypatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr("mailbox_channel_relay_bridging_proxy.viber_adapter.listeners_for",
...
def test_viber_outbound_file_uses_public_attachment_url(monkeypatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr("mailbox_channel_relay_bridging_proxy.viber_adapter.listeners_for",
                        lambda adapter: [listener])
    monkeypatch.setattr("mailbox_channel_relay_bridging_proxy.viber_adapter.attachment_url",
